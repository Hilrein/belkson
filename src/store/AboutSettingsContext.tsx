...
const DEFAULT_ITEMS: AboutSetting[] = [
  {
    ...
    badge: '',
    content:
      'Добро пожаловать в магазин детской одежды BELKSON\n\nМеня зовут Юлия. Здесь вы найдете детскую одежду любимых брендов H&M, ZARA, C&A, Next и другие бренды, которых нет в России.\nТолько оригиналы. Реплику не предлагаю.',
    sortOrder: 1,
    isActive: true,
  },
  {
  ...
  },
  {
    ...
    badge: '',
    content:
      'При покупке от 5 000 руб. — скидка 5%\nПри покупке от 10 000 руб. — скидка 10%\n\nПодарок в каждом заказе.',
    sortOrder: 5,
    isActive: true,
  },
  {
