...
const DELIVERY_SECTIONS = [
  ...
  },
  {
    ...
    content:
      'Возврат возможен в течение 7 дней после получения покупки при полном сохранении товарного вида, бирк и упаковки. Доставка возврата оплачивается покупателем.',
  },
]
